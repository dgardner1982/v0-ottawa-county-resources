...
const RESOURCES: Resource[] = [
  ...
  { name: "Gateway Mission", category: "Housing", address: "643 S Waverly Rd, Holland", phone: "616-396-2200", info: "Emergency shelter and recovery programs for men. Gateway Mission serves as a gateway to a whole new life for hurting people across West Michigan, offering emergency shelter, the Gateway Forge Program for healing with God's love foundation, and recovery community support. Meals start at $2.75.", website: "https://hopefoundhere.org" },
  { name: "Gateway Mission Women & Children's Center", category: "Housing", address: "356 Fairbanks Ave, Holland", phone: "616-396-2200", info: "Specialized residential recovery program for women and children. Provides safe, welcoming environment with meals, shelter, and comprehensive support services. Part of Gateway Mission's commitment to helping individuals and families heal and build a more hopeful future.", website: "https://hopefoundhere.org" },
