...
export default function StreetNamesPage() {
  const streetNames = [
    "PCP", "Phencyclidine", "Angel Dust", "Dust", "Peace Pill", "Lovely",
    "Killer Weed", "Embalming Fluid", "Rocket Fuel", "Ozone", "Wack", "Sherm",
    "Sherman", "Wet", "Dip", "Superjoint", "Fry", "Frying", "Death Trip",
    "Hog", "Horse Tranquilizer", "Elephant Tranquilizer", "Boat", "Zoom", "Goon"
  ];
    ...
    <>
      ...
      <header className="bg-white border-b-2 border-teal-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <h1 className="text-6xl font-bold text-teal-700">PCP - Street Names</h1>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-red-100 border-l-4 border-red-700 p-6 rounded-lg mb-8">
          <h2 className="text-2xl font-bold text-red-900 mb-3">Street Names for PCP</h2>
          <p className="text-gray-700">PCP goes by many different names. Learning these can help identify use and have informed conversations about dangers.</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-12">
          {streetNames.map((name, idx) => (
            <div key={idx} className="p-4 bg-red-50 border border-red-200 rounded-lg font-semibold text-red-900 text-center">
              {name}
            </div>
          ))}
        </div>
